...
<ts>
    ...
    <states>
        ...
        <state id="state0||state2">
            ...
            <transition target="state0||state3" action="c"></transition>
        </state>
        ...
        <state id="state1||state2">
            ...
            <transition target="state1||state3" action="c"></transition>
        </state>
        ...
        <state id="state2||state0">
            ...
            <transition target="state2||state1" action="a"></transition>
        </state>
        ...
        <state id="state2||state2">
            ...
            <transition target="state2||state3" action="c"></transition>
        </state>
        <state id="state2||state3">
            <transition target="state3||state3" action="c"></transition>
        </state>
        <state id="state3||state0">
            <transition target="state3||state1" action="a"></transition>
        </state>
        ...
        <state id="state0||state0">
            ...
            <transition target="state0||state1" action="a"></transition>
        </state>
    </states>
</ts>